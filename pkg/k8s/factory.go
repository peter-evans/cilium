...
import (
	...
	versioned "github.com/cilium/cilium/pkg/versioned"
...
func ResourceEventHandlerFactory(
	...
	im := versioned.NewInterfaceMap()
	lister := listerFactory(listerClient, resourceObj)

	if addFunc != nil && delFunc != nil {
		var newMap versioned.Map
		a := func() error {
			var err error
			newMap = versioned.Map{}
			newMap, err = lister()
			return err
		}
		replace := func(oldMap versioned.Map) versioned.Map {
			added := versioned.Map{}
	...
	if delFunc != nil {
		rehf.DeleteFunc = func(obj interface{}) {
			metrics.SetTSValue(metrics.EventTSK8s, time.Now())
			if metaObj := castToDeepCopy(obj); metaObj != nil {
				if ok := im.Delete(versioned.UUID(k8sUtils.GetObjUID(metaObj))); !ok {
					return
				}
...
func listerFactory(client, obj interface{}) func() (versioned.Map, error) {
	switch obj.(type) {
	...
	case *cilium_v2.CiliumNetworkPolicy:
		return listV2CNP(client.(versionedClient.Interface))
	case *v1.Pod:
...
func listV1NetworkPolicies(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
...
func listV1Services(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV1Endpoints(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV1beta1Ingress(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV2CNP(k8sClient versionedClient.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV1Pod(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV1Node(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
...
func listV1Namespace(k8sClient kubernetes.Interface) func() (versioned.Map, error) {
	return func() (versioned.Map, error) {
